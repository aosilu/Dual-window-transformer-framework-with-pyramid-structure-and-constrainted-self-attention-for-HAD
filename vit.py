...
class ViT(nn.Module):
    def __init__(self, band, num_patches, num_classes, dim, depth, heads, mlp_dim, pool='cls',
...
'''
img = torch.randn(1500, 24, 89)
weight = torch.randn(1500, 24, 24)
preds = model_vit(img, weight)
'''
